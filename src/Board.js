 ...
 */
    ...
    hasAnyRowConflicts: function() {
      var self = this;
      return this.rows().reduce(function(result, nextRow, rowIndex) {
        return result || self.hasRowConflictAt(rowIndex);
      }, false); 
    },
    ...
    hasColConflictAt: function(colIndex) {
      var counter = 0;
      var result = this.rows().reduce(function(result, row){
        if (row[colIndex]) {
          counter++;
        }
    ...
    hasAnyColConflicts: function() {
      ...
      return this.rows().reduce(function(result, _, colIndex){
        return result || self.hasColConflictAt(colIndex);
      }, false);
    },
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      var _matrix = this.rows();
      var length = _matrix[0].length;
      var counter = 0;
      var x, y;
    ...
    hasAnyMajorDiagonalConflicts: function() {
      ...
      return this.rows().reduce(function(result, _, index){
        if (index === 0) {
          return result || self.hasMajorDiagonalConflictAt(index);
        } else {
          return result || self.hasMajorDiagonalConflictAt(index) || self.hasMajorDiagonalConflictAt(-index);
        }
      }, false);
    },
